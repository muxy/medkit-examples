<template>
  ...
  <div class="toast-demo-config">
    ...
    <ui-button raised color="primary" size="small" @click="save">Save</ui-button>
  </div>
</template>
...
export default {
  ...
  // Here we import the button and select dropdown from KeenUI to make the elements look nicer.
